...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { description: @donation.description, has_packing: @donation.has_packing, quantity: @donation.quantity, shelf_life: @donation.shelf_life } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { description: @donation.description, has_packing: @donation.has_packing, quantity: @donation.quantity, shelf_life: @donation.shelf_life } }
